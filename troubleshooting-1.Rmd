...
# Error: Variables can't start with an underscore
```
...
# Error: To load a package, you would type library(<name of package>) not "libraries".
```
...
# Error: Functions are passed using parentheses.
```
